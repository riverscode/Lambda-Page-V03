    ...
    <div className="px-6 md:px-0 mt-24 md:mt-32 max-w-7xl mx-auto text-white text-center ">
      ...
      <div className="mt-8 md:mt-16 space-y-8">
        <CollapsableText question="¿Necesito conocimiento previo para los cursos?">
          <p>
            Todos nuestro cursos están cuidadosamente elaborados con una
            estructura académica para que estudiantes de diferentes niveles
            puedan comprender su contenido. Se abordarán desde una metología de
            estudio que mezcla la teoría y la práctica en{" "}
            <span className="text-emerald-500 underline decoration-wavy font-bold">
              proyectos reales.
            </span>
          </p>
          <p className="mt-4">
            Cuando accedes a la plataforma exclusiva de Lambda Ingeniería e
            Innovación, tendrás acceso a{" "}
            <span className="text-emerald-500 underline decoration-wavy font-bold">
              {" "}
              videos pregrabados{" "}
            </span>{" "}
            con conceptos fundamentales que te guiarán de manera óptima durante
        ...
        <CollapsableText question="¿Las clases serán en vivo?">
          <p >
            Las clases serán en vivo para reforzar el material complementario
          ...
          <p className="mt-4">
            Todas nuestras sesiones en vivo serán grabadas en calidad de{" "}
            <span className="text-emerald-500 underline decoration-wavy font-bold">
              {" "}
              Video 1080HD y Audio en HQ{" "}
            </span>
            para que los alumnos puedan revisar de manera óptima la información
            brindada por Lambda Ingeniería e Innovación.
          </p>
        </CollapsableText>
