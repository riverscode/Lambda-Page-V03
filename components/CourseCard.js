      ...
      <Link href={`/cursos/${slug}`}>
        <a>
          ...
          <div className="p-4">
            ...
            <div className="flex">
              <p className=" font-light line-through text-gray-400 text-2xl ">
                {price}{" "}
              </p>
              <span className="text-red-400 font-medium text-2xl ml-3">
                {discount}
              </span>
            </div>
            <div className="font-semibold text-sm mt-3 bg-blue-700 rounded-md px-2 py-2 flex items-center w-40">
              <svg
              ...
              <p className="ml-3 text-xl">{finalPrice}</p>
            </div>
          </div>
        </a>
      </Link>
